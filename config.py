...
EMBEDDINGS_API_KEY: Final[str] = os.getenv("EMBEDDINGS_API_KEY", "")

# Model selection
LLM_MODEL: Final[str] = "claude-sonnet-4-20250514"
LLM_MODEL_FAST: Final[str] = "claude-haiku-4-20250514"  # For evals/grading
EMBEDDINGS_MODEL: Final[str] = "voyage-3"  # SOTA for enterprise/legal/finance
...
def validate_config() -> None:
    ...
    if not LLM_API_KEY:
        raise ValueError(
            ...
            "Set it with: export LLM_API_KEY='your-key'"
        )
    # Embeddings API is optional - we can fall back to mock embeddings
    if not EMBEDDINGS_API_KEY:
        print("Warning: EMBEDDINGS_API_KEY not set. Using mock embeddings.")
