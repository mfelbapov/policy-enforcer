...
class PolicyResponse(BaseModel):
    ...
    By defining this schema, we can validate that the model's
...
class OutputGuardrails:
    """
    Validate the model's output before returning to user.
    ...
    def validate_structured_response(self, response_text: str) -> tuple[bool, Optional[PolicyResponse], Optional[str]]:
        ...
        Args:
            response_text: JSON string from the model
...
def should_escalate(
    ...
    Args:
        ...
        response_confidence: Confidence from the model's response
    ...
    # Low response confidence = the model is uncertain
...
class GuardrailsPipeline:
    ...
    def validate_output(self, response_text: str) -> tuple[bool, Optional[PolicyResponse], Optional[str]]:
        """Validate the model's structured response."""
